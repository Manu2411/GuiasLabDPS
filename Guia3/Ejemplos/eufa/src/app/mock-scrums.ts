...
export const SCRUMS: Scrum[]=[
    ...
    {id:7, name:'Bayer Leverkusen', players:['Javier Hernández','Hakan']},
    {id:8, name:'Dortmund', players:['Marcos Reus','Pierre Emerick', 'Mario Götze']},
    {id:9, name:'Leicester City', players:['Jamie Vardy','Ryad Mahrez']},
